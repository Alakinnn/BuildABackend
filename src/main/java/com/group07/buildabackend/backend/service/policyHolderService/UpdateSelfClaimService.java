...
public class UpdateSelfClaimService extends PolicyHolderService {
    public static Response<InsuranceClaim> updateSelfClaim(InsuranceClaimDTO insuranceClaimDTO){
        ...
        try{
            ...
            if(policyHolder == null){
                throw new InvalidInputException("Policy holder not found", 404);
            }

            InsuranceClaim selfClaim = policyHolderRepository.retrieveOneClaimByActorId(insuranceClaimDTO.getId(), policyHolder.getUserId());
