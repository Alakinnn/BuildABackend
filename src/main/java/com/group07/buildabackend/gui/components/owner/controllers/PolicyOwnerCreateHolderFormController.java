...
public class PolicyOwnerCreateHolderFormController extends FormController<PolicyHolder> implements ComponentController, Initializable {
    @FXML
    ...
    public void presetPolicyOwnerId(String poId) {
        policyOwnerChoice.setValue(new ChoiceField<>("Myself", poId));
        policyOwnerChoice.setDisable(true);
    }
